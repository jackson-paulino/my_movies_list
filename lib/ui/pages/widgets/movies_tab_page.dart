      ...
      child: ListView(
        children: [
          FutureBuilder<List<TitleModel>>(
            future: _repository
                .getTvMovieList(isTvShow: false, params: {'genre': 10749}),
          ...
          FutureBuilder<List<TitleModel>>(
            future: _repository
                .getTvMovieList(isTvShow: false, params: {'genre': 16}),
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return const Text('Carregando');
              }
          ...
          FutureBuilder<List<TitleModel>>(
            future: _repository
                .getTvMovieList(isTvShow: false, params: {'genre': 27}),
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return const Text('Carregando');
              }
          ...
          FutureBuilder<List<TitleModel>>(
            future: _repository
                .getTvMovieList(isTvShow: false, params: {'genre': 80}),
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return const Text('Carregando');
              }
